...
this.props,value=_props.value,defaultValue=_props.defaultValue,rows=_props.rows,error=_props.error,clear=_props.clear,count=_props.count,autoHeight=_props.autoHeight,last=_props.last,onErrorClick=_props.onErrorClick,styles=_props.styles;
...
return _react2["default"].createElement(_reactNative.View,{style:[styles.container,containerStyle,{position:'relative'}]},
