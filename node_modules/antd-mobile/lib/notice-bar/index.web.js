...
var _Marquee=require('./Marquee');var _Marquee2=_interopRequireDefault(_Marquee);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj};}var
...
(0,_splitObject4["default"])(this.props,['mode','icon','onClick','children','className','prefixCls','marqueeProps']),_splitObject2=(0,_slicedToArray3["default"])(_splitObject,2),_splitObject2$=_splitObject2[0],mode=_splitObject2$.mode,icon=_splitObject2$.icon,onClick=_splitObject2$.onClick,children=_splitObject2$.children,className=_splitObject2$.className,prefixCls=_splitObject2$.prefixCls,marqueeProps=_splitObject2$.marqueeProps,restProps=_splitObject2[1];
var extraProps={};
